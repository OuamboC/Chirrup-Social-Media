<template>
    <div>
        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
            ...
            <!-- Success Message -->
            <div v-if="showSuccess" class="flex items-center p-3 bg-green-50 border border-green-200 rounded-lg text-green-800 text-sm">
            ...
            <!-- Error Message -->
            <div v-if="errorMessage" class="flex items-center p-3 bg-red-50 border border-red-200 rounded-lg text-red-800 text-sm">
                <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
