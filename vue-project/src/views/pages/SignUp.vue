        ...
        <div class="max-w-md w-full">
            ...
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-green-600 px-8 py-6">
                    ...
                    <h2 class="text-3xl font-bold text-white text-center">Join Chirrup Today!</h2>
                    <p class="text-blue-100 text-center mt-2">Create your account and start connecting</p>
                </div>
                ...
                <div class="px-8 py-8">
                    <form @submit.prevent="handleSubmit" class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    :class="{'border-red-500 ring-2 ring-red-500': submitted && !first_name}"
                                />
                            </div>
                            <p v-show="submitted && !first_name" class="mt-2 text-sm text-red-600 flex items-center">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-gray-900 placeholder-gray-400"
                                    :class="{'border-red-500 ring-2 ring-red-500': submitted && !last_name}"
                                />
                            </div>
                            <p v-show="submitted && !last_name" class="mt-2 text-sm text-red-600 flex items-center">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                                </svg>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-gray-900 placeholder-gray-400"
                                    :class="{'border-red-500 ring-2 ring-red-500': submitted && !username}"
                                />
                            </div>
                            <p v-show="submitted && !username" class="mt-2 text-sm text-red-600 flex items-center">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                                </svg>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input 
                                    ...
                                    class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 text-gray-900 placeholder-gray-400"
                                    :class="{'border-red-500 ring-2 ring-red-500': submitted && !password}"
                                />
                            </div>
                            <p v-show="submitted && !password" class="mt-2 text-sm text-red-600 flex items-center">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                                </svg>
                        ...
                        <!-- Success Message -->
                        <div v-if="successMessage" class="bg-green-50 border-l-4 border-green-500 rounded-lg p-4 animate-fade-in">
