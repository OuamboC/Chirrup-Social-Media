        ...
        <div class="max-w-2xl w-full">
            ...
            <div class="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-200">
                ...
                <div class="bg-gradient-to-r from-blue-600 to-green-600 px-8 py-6">
                    ...
                    <h2 class="text-3xl font-bold text-white text-center">Edit Your Post</h2>
                    <p class="text-blue-100 text-center mt-2">Update your thoughts and ideas</p>
                </div>
                ...
                <div class="px-8 py-8">
                    ...
                    <div v-if="loading" class="flex flex-col items-center justify-center py-8">
                        <div class="relative">
                            ...
                            <div class="absolute top-0 left-0 h-12 w-12 border-t-4 border-b-4 border-green-600 rounded-full animate-ping opacity-20"></div>
                        </div>
                        <p class="mt-4 text-gray-600 font-medium">Loading post...</p>
                    </div>

                    <!-- Error State -->
                    <div v-if="error" class="mb-6 bg-red-50 border-l-4 border-red-500 rounded-lg p-4">
                    ...
                    <form v-if="!loading" @submit.prevent="handleSubmit" class="space-y-6">
                        ...
                        <div v-if="originalText" class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                            <p class="text-xs font-semibold text-gray-500 uppercase mb-2">Original Post</p>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <textarea
                                    ...
                                    :class="{'border-red-500 ring-2 ring-red-500': submitted && !text}"
                                    maxlength="500"
                                ></textarea>
                            ...
                            <p v-show="submitted && !text" class="mt-2 text-sm text-red-600 flex items-center">
                        ...
                        <div class="bg-blue-50 border-l-4 border-blue-500 rounded-lg p-4">
                            <div class="flex items-start">
                                ...
                                <p class="text-sm text-blue-700">Your updated post will be visible to all your followers</p>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        loadPost() {
            ...
            postService.getposts(this.post_id)
                .then((post) => {
                    this.text = post.text;
                ...
                .catch((error) => {
                    this.error = error || "Failed to load post. You may not have permission to edit this post.";
                    this.loading = false;
                });
        },
        handleSubmit() {
            ...
            authPostService.updatePosts(this.post_id, this.text)
                ...
                .catch((error) => {
                    ...
                    this.error = error || "Failed to update the post. You can only edit your own posts.";
