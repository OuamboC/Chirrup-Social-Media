    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div class="flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-8">
                    ...
                    <div class="flex-1 text-center md:text-left">
                        ...
                        <p class="text-xl text-blue-100 mb-4">@{{ userProfile.username }}</p>
                        
                        <!-- User Stats -->
                        <div class="flex justify-center md:justify-start space-x-8 mt-6">
                            <div class="text-center">
                                <div class="text-3xl font-bold text-white">{{ userPosts.length }}</div>
                                <div class="text-sm text-blue-100">Posts</div>
                            </div>
                            <div class="text-center">
                                <div class="text-3xl font-bold text-white">{{ userProfile.followers || 0 }}</div>
                                <div class="text-sm text-blue-100">Followers</div>
                            </div>
                            <div class="text-center">
                                <div class="text-3xl font-bold text-white">{{ userProfile.following || 0 }}</div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 mb-2">
                            <span class="bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent">My Posts</span>
                        </h2>
            ...
            <div v-if="loading" class="flex flex-col items-center justify-center py-12">
                ...
                <p class="mt-4 text-gray-600 font-medium text-lg">Loading your posts...</p>
            </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="pt-4 border-t border-gray-100 flex items-center justify-between text-sm text-gray-500">
                            <div class="flex items-center space-x-4">
                                <span class="flex items-center hover:text-red-600 transition duration-200">
            ...
            <!-- Empty State -->
            <div v-if="!loading && !error && userPosts.length === 0" class="text-center py-16">
                <div class="bg-white rounded-xl shadow-md p-12 border border-gray-100">
                    ...
                    <p class="text-gray-500 text-lg mb-6">Start sharing your thoughts with the world!</p>
...
export default {
    ...
    methods: {
            ...
            postService.getusers(userId)
                ...
                .then(allPosts => {
                    ...
                    this.userPosts = allPosts.filter(post => {
                        ...
                        const postUserId = post.user_id || (post.author && post.author.user_id);
                ...
                .catch(error => {
                    ...
                    this.error = typeof error === 'string' ? error : 'Failed to load profile data';
                    this.loading = false;
                });
        },
        ...
        deletePost(postId) {
            authPostService.deletePosts(postId)
                .then(() => {
                    // Remove the deleted post from the list
                    this.userPosts = this.userPosts.filter(post => post.post_id !== postId);
