    ...
    <div class="bg-gradient-to-br from-blue-50 via-white to-green-50 py-12">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8">
                <h1 class="text-4xl font-bold text-gray-900 mb-3">Welcome to Chirrup!</h1>
                <p class="text-lg text-gray-600">Connect, share, and discover amazing content</p>
            </div>
    ...
    <div class="bg-gray-50 min-h-screen py-8">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <div class="h-1 w-20 bg-gradient-to-r from-blue-600 to-green-600 rounded-full"></div>
            </div>
            ...
            <div v-if="!posts.length && !loading && !error" class="text-center py-16">
                <div class="bg-white rounded-xl shadow-md p-12 border border-gray-200">
                    ...
                    <p class="text-gray-500 text-lg">Be the first to share something amazing!</p>
                </div>
            </div>
        </div>
    </div>
