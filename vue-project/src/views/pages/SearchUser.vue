<template>
  ...
  >
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="text-center mb-8">
          ...
          <p class="text-lg text-blue-100">
            Discover and connect with users on Chirrup
          </p>
        </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <router-link :to="'/users/' + result.user_id" class="block p-6">
            <div class="flex items-center space-x-4">
              ...
              <div class="flex-shrink-0">
                <div
                  class="w-16 h-16 bg-gradient-to-br from-blue-500 to-green-500 rounded-full flex items-center justify-center text-white font-bold text-2xl shadow-md group-hover:shadow-lg transition-shadow duration-300"
                >
              ...
              <div class="flex-1 min-w-0">
                <h3
                  class="text-xl font-semibold text-gray-900 group-hover:text-blue-600 transition-colors duration-200 truncate"
                >
                ...
                <!-- View Profile Button -->
                <span
                  class="inline-flex items-center text-sm font-medium text-blue-600 group-hover:text-green-600 transition-colors duration-200"
                >
                  View Profile
                  <svg
      ...
      <div
        v-if="!loading && !submitted && search.length === 0"
      ...
      >
        <div class="bg-white rounded-xl shadow-md p-12 border border-gray-200">
          ...
          <p class="text-gray-500 text-lg">
            Search for users to connect with on Chirrup
          </p>
        </div>
      </div>
